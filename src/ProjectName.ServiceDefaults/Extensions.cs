            ...
            .WithTracing(tracing =>
            {
                _ = tracing.AddSource(builder.Environment.ApplicationName)
                    ...
                    .AddEntityFrameworkCoreInstrumentation(options =>
                    {
                        ...
                        {
                            // Add SQL text tags so EF Core commands are visible in traces.
                            _ = activity.SetTag("db.statement", command.CommandText);
                            _ = activity.SetTag("db.query.text", command.CommandText);
                        };
                    })
