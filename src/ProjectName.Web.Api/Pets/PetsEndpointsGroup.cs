...
/// <summary>
/// Represents a group of endpoints related to pet management, including creating, retrieving, updating, and managing pet vaccine administrations. This class provides methods to map the endpoints to the application's routing system and configure their behavior, such as authorization requirements and display information.
/// </summary>
public static class PetsEndpointsGroup
{
    ...
    public static RouteGroupBuilder MapPetsEndpoints(this WebApplication app)
    {
        ...
        _ = group.MapGet(string.Empty, GetPetsEndpoint.HandleAsync)
        ...
        _ = group.MapGet("{id:guid}", GetPetEndpoint.HandleAsync)
        ...
        _ = group.MapPost(string.Empty, CreatePetEndpoint.HandleAsync)
        ...
        _ = group.MapPut("{id:guid}", UpdatePetEndpoint.HandleAsync)
        ...
        _ = group.MapDelete("{id:guid}", DeletePetEndpoint.HandleAsync)
        ...
        _ = group.MapPost("{id:guid}/transfer-ownership", TransferPetOwnershipEndpoint.HandleAsync)
        ...
        _ = group.MapGet("{id:guid}/vaccine-administrations", GetPetVaccineAdministrationsEndpoint.HandleAsync)
        ...
        _ = group.MapPost("{id:guid}/vaccine-administrations", AddVaccineAdministrationEndpoint.HandleAsync)
        ...
        _ = group.MapDelete("{id:guid}/vaccine-administrations/{vaccineAdministrationId:guid}", RemoveVaccineAdministrationEndpoint.HandleAsync)
