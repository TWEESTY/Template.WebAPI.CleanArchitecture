...
/// <summary>
/// Represents the endpoint for deleting a vaccine. This endpoint removes a vaccine identified by its ID and returns a no-content response on success or appropriate error responses if the vaccine cannot be deleted.
/// </summary>
internal static class DeleteVaccineEndpoint
{
