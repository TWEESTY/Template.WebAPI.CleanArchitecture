...
/// <summary>
/// Represents a logging behavior that is used in the application to log the start and completion of requests.
/// It logs the request details unless the request type is decorated with the ExcludeMessageFromLogging attribute, in which case it logs a message indicating that the request details are excluded due to a large payload.
/// </summary>
